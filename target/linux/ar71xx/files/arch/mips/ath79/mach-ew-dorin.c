...
#define DORIN_GPIO_LED_R		6
#define DORIN_GPIO_LED_B		7
#define DORIN_GPIO_LED_G		8

#define DORIN_GPIO_BTN_JUMPSTART	11
#define DORIN_GPIO_BTN_RESET		27
#define DORIN_GPIO_BTN_WITCH1		12

static struct gpio_led dorin_leds_gpio[] __initdata = {
	{
		.name		= "redled",
		.gpio		= DORIN_GPIO_LED_R,
		.active_low	= 1,
	},
	{
		.name		= "buleled",
		.gpio		= DORIN_GPIO_LED_B,
		.active_low	= 1,
	},
	{
		.name		= "greenled",
		.gpio		= DORIN_GPIO_LED_G,
		.active_low	= 1,
	},
};
