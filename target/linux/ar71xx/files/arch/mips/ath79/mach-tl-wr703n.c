...
#define MB8800_GPIO_LED_R		6
#define MB8800_GPIO_LED_B		7
#define MB8800_GPIO_LED_G		8
#define MB8800_GPIO_BTN_RESET		27
#define MB8800_GPIO_BTN_SWITCH1		12
...
static struct gpio_led tl_wr703n_leds_gpio[] __initdata = {
	...
	{
		.name		= "redled",
		.gpio		= MB8800_GPIO_LED_R,
		.active_low	= 1,
	},
	{
		.name		= "buleled",
		.gpio		= MB8800_GPIO_LED_B,
		.active_low	= 1,
	},
	{
		.name		= "greenled",
		.gpio		= MB8800_GPIO_LED_G,
		.active_low	= 1,
	},
};
...
static void __init tl_wr703n_setup(void)
{
	...
	//printk(KERN_INFO"mac= %02hhx:%02hhx:%02hhx:%02hhx:%02hhx:%02hhx\n",mac[0],mac[1],mac[2],mac[3],mac[4],mac[5]);
