...
#define AR7240_FRAC_FREQ					AR7240_PLL_BASE+0x34
...
#define AR7240_GPIO_FUNCTION_2_SPDIF_ON23		(1<< 2)
 ...
 */
#define AR7240_STEREO_CONFIG_CLOCK_SEL	(1<<24)
#define AR7240_STEREO_CONFIG_DIV_BYPASS (1<<25)
#define AR7240_STEREO_CONFIG_SPDIF_ENABLE		(1<<23)
#define AR7240_STEREO_CONFIG_REFCLK_SEL (1<<22)
